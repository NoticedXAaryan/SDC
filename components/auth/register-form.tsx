...
export function RegisterForm() {
  ...
  return (
    <VStack gap={8}>
      {/* Header */}
      <VStack gap={2}>
        <Text as="h2" weight="bold" className="text-2xl tracking-tight">Create an account</Text>
      ...
      <form onSubmit={handleRegister} className="space-y-4">
        ...
        <Button 
          type="submit" 
          className="w-full" 
          isDisabled={loading || (!turnstileToken && !!process.env.NEXT_PUBLIC_TURNSTILE_SITE_KEY)}
